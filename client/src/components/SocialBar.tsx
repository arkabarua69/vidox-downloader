...
export default function SocialBar() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 sm:bottom-6">
      {open && (
        <div className="absolute bottom-14 right-0 mb-0 rounded-2xl p-4 w-64 animate-in fade-in slide-in-from-bottom-2 duration-200"
          style={{ background: "#111115", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 8px 32px rgba(0,0,0,0.4)" }}>
          <div className="mb-3">
            <p className="text-sm font-semibold text-text-primary">Contact Us</p>
          </div>
          <div className="space-y-2">
            <a href="https://wa.me/8801883800356" target="_blank" rel="noopener noreferrer"
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: "#5a5a6e" }}>Chat with us</p>
              </div>
            </a>
            <a href="https://discord.gg/dJ4WRX4eYE" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2.5 p-2.5 rounded-xl hover:bg-white/5 transition-colors">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: "#5a5a6e" }}>Join server</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <button onClick={() => setOpen(!open)}
        ...
        style={{ background: "linear-gradient(135deg, #e63946, #ff6b6b)", boxShadow: "0 4px 20px rgba(230,57,70,0.4)" }}>
